...
> To try it: clone the repo and run `./mac/clean-dev-mac.sh`, which only prints what it would clean. Docs are in Traditional Chinese.
...
./mac/clean-dev-mac.sh    # dry-run：只列出會清什麼、可釋放多少
```
